    ...
    <tr>
        <td colspan="3" class="object_content">
            ...
            <div class="object_data">
                {$objektdata.resolved_data.wind_direction}{$default_configuration.datatypes.wind_direction.unit} ({$objektdata.resolved_data.percentage}{$default_configuration.datatypes.percentage.unit})
            </div>
