    ...
    <tr>
        <td colspan="3" class="object_content">
            ...
            <div class="object_data">
                {$objektdata.resolved_data.kilowattstunde}{$default_configuration.datatypes.kilowattstunde.unit} ({$objektdata.resolved_data.active_power_extrapolated}{$default_configuration.datatypes.active_power_extrapolated.unit})
            </div>
            
            {*include file="templates/windrichtung_panel.tpl"*}
