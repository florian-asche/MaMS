<table class="object" bgcolor="{$objekt.objects.configuration.backgroundcolor}">
    ...
    <tr>
        <td colspan="3" class="object_content">
            ...
            <div class="object_data">{$objektdata.resolved_data.temperature_c}{$default_configuration.datatypes.temperature_c.unit}</div>
            <div class="object_data">{$objektdata.resolved_data.target_temperature_c}{$default_configuration.datatypes.target_temperature_c.unit}</div>
            <div class="object_message" id="{$objekt.page_objects.ID}__messageafter"></div>
           
            {include file="templates/{$selected_template}/time.tpl"}
            
            {include file="templates/{$selected_template}/control_panels/default.tpl"}
        </td>
    </tr>
</table>