    ...
    <tr>
        <td colspan="3" class="object_content">
            ...
            <div class="object_data">
                {$objektdata.resolved_data.temperature_c}{$default_configuration.datatypes.temperature_c.unit} & {$objektdata.resolved_data.absolute_pressure}{$default_configuration.datatypes.absolute_pressure.unit}
            </div>
