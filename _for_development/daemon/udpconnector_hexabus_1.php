...
//$message     = chr(0x48).chr(0x58).chr(0x30).chr(0x43).chr(0x02).chr(0x00).chr(0x00).chr(0x00).chr(0x00).chr(0x02).chr(0xf7).chr(0xf7);                       //CRC ERROR
...
//echo calculate_common_crc16c(chr(0x48));
...
//for ($y = 0; $y < 8; $y++) {
//
//if ( ($crc & 0x0000) == 0x0000 ) $crc = ( ($crc >> 1 ) ^ 0x1021 );
//else $crc = $crc >> 1;
//}
//}
//
...
//}
//
//echo crc16_kermit(chr(0x48));


//
//    echo '<pre>';
//    print_r(str2hex_encoder("19662"));
//    echo '</pre>';
//exit;
...
if (!$write) {
    echo "ERROR: cannot wrtiting to Port!";
    exit;
};
...
if ($packetType == "info") {
    if ($eid == "0001") {
        ...
        echo "HexabusPlug+ Power = " . $value . " Watt";
    } else {
        echo "ERROR: unknown EID!";
        exit;
    };
};
